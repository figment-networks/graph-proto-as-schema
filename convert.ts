import {ObjectTypeDefinitionNode, NameNode, StringValueNode, DirectiveNode, FieldDefinitionNode, NonNullTypeNode, NamedTypeNode, ListTypeNode, EnumTypeDefinitionNode, DocumentNode, EnumValueDefinitionNode} from "./types";
import * as t from "proto-parser";
import * as graphql from "graphql";

export function toSchemaObjects(protoDocument: t.ProtoDocument): graphql.DocumentNode {
    let arr = new Array();
